...
import 'package:restaurant/model/like_model.dart';
...
class LikeButton extends StatefulWidget {
  ...
  const LikeButton({
    ...
    this.likeModel = const LikeModel(
      dotPrimaryColor: const Color(0xFFFFC107),
      dotSecondaryColor: const Color(0xFF4CAF50),
      dotThirdColor: const Color(0xFFFFC107),
      dotLastColor: const Color(0xFFFFC107),
    ),
    this.circleStartColor = const Color(0xFFFFC107),
      ...
      children: <Widget>[
        CustomPaint(
          ...
          painter: DotPainter(
            ...
            color1: widget.likeModel.dotPrimaryColor,
            color2: widget.likeModel.dotSecondaryColor,
            color3: widget.likeModel.dotThirdColorReal,
            color4: widget.likeModel.dotLastColorReal,
          ),
        ),
        CustomPaint(
